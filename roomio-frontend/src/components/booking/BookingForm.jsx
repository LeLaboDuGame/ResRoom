...
export function BookingForm({
                                ...
                                defaultHour: defaultHourProp,
                                defaultMinute: defaultMinuteProp,
                                onTimeChange
                            }) {
    ...
    async function handleSubmit() {
        ...
        if (selectedEmails.length === 0) {
            setError("Veuillez rentrer au moins une adresse email.");
            return;
        }
            ...
            <Flex direction="column" gap={4}>
                ...
                <Box position="relative" ref={emailDropdownRef}>
                    ...
                    >
                        {selectedEmails.map((email, index) => (
                            <Flex
                                ...
                                align="center"
                                gap={1}
                                bg={index === 0 ? "yellow.500" : "accent.default"}
                    ...
                    <Text fontSize="xs" color="text.muted" mt={1}>
                        👑 La première adresse email est l'organisateur de la réunion
                    </Text>
                </Box>
